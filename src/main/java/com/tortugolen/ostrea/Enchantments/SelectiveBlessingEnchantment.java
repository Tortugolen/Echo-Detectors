...
public class SelectiveBlessingEnchantment extends Enchantment {
    ...
    public boolean canEnchant(ItemStack pStack) {
        return pStack.is(InitItems.PEARL_NECKLACE.get()) || pStack.is(InitItems.PEARL_RING.get()) || pStack.is(InitItems.PEARLED_MIRROR.get()) || pStack.is(InitItems.PEARL_BRACELET.get());
    }
