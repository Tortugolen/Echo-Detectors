...
public class AbstractTrigger1 extends SimpleCriterionTrigger<AbstractTrigger1.Instance> {
    public static final ResourceLocation ID = new ResourceLocation(Ostrea.MOD_ID, "abstract1");
    public static final AbstractTrigger1 INSTANCE = new AbstractTrigger1();
    ...
    public static class Instance extends AbstractCriterionTriggerInstance {
        public Instance(ContextAwarePredicate pPredicate) {
            super(AbstractTrigger1.ID, pPredicate);
        }
    }
}
