...
public class AbstractTrigger3 extends SimpleCriterionTrigger<AbstractTrigger3.Instance> {
    public static final ResourceLocation ID = new ResourceLocation(Ostrea.MOD_ID, "abstract3");
    public static final AbstractTrigger3 INSTANCE = new AbstractTrigger3();
    ...
    public static class Instance extends AbstractCriterionTriggerInstance {
        public Instance(ContextAwarePredicate pPredicate) {
            super(AbstractTrigger3.ID, pPredicate);
        }
    }
}
